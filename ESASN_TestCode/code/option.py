...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/media/data4/wangzirui/',
...
parser.add_argument('--model', default='PAN',
                    help='model name')
